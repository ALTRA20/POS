...
<script>
    ...
    function toPesanan(userId) {
            ...
            .then(response => response.text())
            .then(datas => {
                window.location.href = '/pages/pemesanan/terimaBayarQR.php?i='+datas;
            })
            .catch((error) => {
                console.error('Error:', error);
            });
    ...
    function submit(id, userId) {
        ...
        fetch('/components/keranjang/tambahKeKeranjangQR.php', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
