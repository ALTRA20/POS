    ...
    function sendData(userId,page,search) {
        ...
        .then(datas => {
          if(datas['datas'].length == 0){
            let buttonCus = `<h1 class="text-danger d-flex align-items-center fw-bold" style="font-size:100px; font-weight:1200;">PRODUK TIDAK ADA</h1>`;
    ...
    function makeCard(data) {
        ...
        let card = `<div class="row p-3 h-fit" data-bs-toggle="modal" data-bs-target="#card${id}">
            <div class="col-7 position-relative">
                <img src="${gambar}" alt="" class="w-100 h-90 p-0 m-0">
